...
- วัสดุก่อสร้าง (BOQ) ต่อ Cost Center + สต๊อกวัสดุ (รับเข้า/เบิกใช้/ปรับปรุงยอด) พร้อมแจ้งเตือนเมื่อถึงจุดสั่งซื้อเพิ่ม — กรอกรายการเองได้ หรือใช้ **เทมเพลต BOQ มาตรฐาน** (ดัดแปลงจากใบประมาณราคาจริงของบ้านชั้นเดียว คสล. 52 ตร.ม. 11 หมวดงาน 137 รายการ) แล้วระบุพื้นที่ใช้สอยของบ้านหลังใหม่ ระบบคำนวณปริมาณ/ราคาตามสัดส่วนพื้นที่ให้อัตโนมัติก่อนสร้างเป็นรายการจริง (เป็นค่าประมาณ ต้องตรวจสอบกับใบเสนอราคาจริงอีกครั้ง)
- ขั้นตอนงานก่อสร้าง (เทมเพลตชื่อ/ลำดับขั้นตอนสำหรับบ้านชั้นเดียวและบ้านสองชั้น รวมรั้ว/โรงจอดรถ/ต่อเติมครัว) + Timeline แผนเทียบจริงต่อขั้นตอน คำนวณ Lead Time จากวันที่จริงที่บันทึกไว้ (ไม่ใช่ค่าประมาณการ) + กราฟสะสมมูลค่างาน (S-Curve แผนเทียบจริง) จากมูลค่างาน (บาท) ที่กรอกต่อขั้นตอน + งวดงานการชำระเงิน (Payment Milestones) บันทึกยอดที่ต้องเรียกเก็บ วันครบกำหนด และวันที่รับเงินจริงต่อบ้าน — สร้างงวดทั้งหมดในทีเดียวจากมูลค่าสัญญารวม + % แต่ละงวดตามสัญญาจ้างเหมาจริงก็ได้ (ระบบตรวจว่า % รวมต้องเท่ากับ 100 ก่อนสร้าง) + ตารางคำนวณ Feasibility แบบละเอียดต่อโครงการ — กรอกต้นทุนเป็นรายการย่อยแยกหมวด (ที่ดิน/ก่อสร้าง/สาธารณูปโภคส่วนกลาง/ค่าใช้จ่ายโครงการ/ต้นทุนทางการเงิน) พร้อมคำนวณ Gross Profit, EBIT, EBT, Net Profit, ROS, ROI, ROE (ผู้ใช้กรอกรายการ/จำนวนเงินจริงเอง ระบบไม่มีค่ามาตรฐานในตัว)
- Dashboard การเงินพื้นฐาน (เงินสดคงเหลือ, AR/AP Aging, P&L ต่อ Cost Center, กระแสเงินสด 90 วัน) + กราฟแท่งรายรับ-รายจ่าย สลับดูได้ทั้งรายวัน/รายเดือน/รายปี + กราฟค่าแรงช่างและค่าวัสดุที่จ่าย (จากทะเบียนใบแจ้งหนี้ผู้จำหน่าย) + ตารางรายจ่ายแยกตามหมวดงาน (จากบิล/ใบแจ้งหนี้ที่บันทึกในระบบ แทนการทำบัญชีมือใน Excel)
- ใบหัก ณ ที่จ่าย พร้อม export CSV สำหรับยื่นสรรพากรเอง
- นำเข้าบัญชีรายรับ-รายจ่ายย้อนหลังจากไฟล์ Excel ของบริษัท (หลายชีท/หลายปีในไฟล์เดียว) — ตรวจสอบและสรุปยอดก่อนนำเข้าจริง (คัดกรองชีทที่ไม่ใช่บัญชีหลัก, หักลบส่วนลด, ตัดแถวสรุปยอดรวม, ตัดรายการซ้ำอัตโนมัติ) จากนั้น CEO ยืนยันเพื่อสร้างบิล/ใบแจ้งหนี้/การชำระเงินจริงพร้อม Cost Center และคู่ค้าที่เกี่ยวข้องทั้งหมดในทีเดียว — พร้อมนำเข้าทะเบียนใบแจ้งหนี้ผู้จำหน่าย (ชีท "ค่าของ"/"ค่าแรง") แยกต่างหากสำหรับกราฟค่าแรง/ค่าวัสดุ โดยไม่สร้างเป็นบิลซ้ำ (ตัดรายการซ้ำอัตโนมัติหากนำเข้าไฟล์เดิมซ้ำ)
