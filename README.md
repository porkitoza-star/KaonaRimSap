...
- ขั้นตอนงานก่อสร้าง (เทมเพลตชื่อ/ลำดับขั้นตอนสำหรับบ้านชั้นเดียวและบ้านสองชั้น รวมรั้ว/โรงจอดรถ/ต่อเติมครัว) + Timeline แผนเทียบจริงต่อขั้นตอน คำนวณ Lead Time จากวันที่จริงที่บันทึกไว้ (ไม่ใช่ค่าประมาณการ) + ตารางคำนวณ Feasibility ต้นทุน/กำไร/Margin ต่อโครงการ (ผู้ใช้กรอกสมมติฐานต้นทุน/ราคาขายเอง)
