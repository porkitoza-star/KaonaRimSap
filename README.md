...
- วัสดุก่อสร้าง (BOQ) ต่อ Cost Center + สต๊อกวัสดุ (รับเข้า/เบิกใช้/ปรับปรุงยอด) พร้อมแจ้งเตือนเมื่อถึงจุดสั่งซื้อเพิ่ม — ผู้ใช้กรอกรายการ/ปริมาณเองตามมาตรฐานจริงของแต่ละโครงการ (ระบบไม่มีค่ามาตรฐานในตัว) พร้อมราคาวัสดุ/ค่าแรงต่อหน่วยและหมวด Feasibility ต่อรายการ เพื่อดึงยอดรวม BOQ จริงของทุกบ้านในโครงการเข้าเป็นรายการต้นทุนใน Feasibility ได้โดยไม่ต้องกรอกซ้ำ
